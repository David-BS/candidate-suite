...
On the Generate click, the widget sends (via `sendPrompt`) a visible message: chosen deliverables, posting, possibly modified candidate data, signature instruction if the letter is checked. On receipt:
